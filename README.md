...
You take a screenshot. You want to paste it into a terminal-based tool (Claude Code, Cursor, etc.). But terminals don't accept image paste — you have to save the file, find the path, drag it in, or type it out.
